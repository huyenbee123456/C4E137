...
//         b>0 && b < 13 &&
//         c>0) {
//         return "Ngày tháng năm hợp lệ"
//     }
//     else {
//         return "Không hợp lệ"
//     }
// }
// a = Number(prompt("Nhập ngày"));
// b = Number(prompt("Nhập tháng"));
// c = Number(prompt("Nhập năm"));
// console.log (BT3 (a,b,c))
...
//     }
//     return null //không tìm thấy người dùng nào;
// }
// let n = prompt ("Nhập vào số n");
// let user = findUserByID (n);

// if (user) {
//     console.log (`Người dùng có ID ${n} ${user.first_name} ${user.last_name}, email: ${user.email}, age: ${user.age}, job: ${user.job}, country: ${user.country}`) 
// }

// else {
//     console.log ("Không có người dùng có ID " + n)
// }
...
//   }
// }
// const emails = matchingUsers.map(user => user.email);
// console.log(`Các email của người dùng có tên chứa keyword '${keyword}':`);
// console.log(emails);
...
for (let i = 0; i<users.length; i++) {
    if (users[i].job == "Project Manager") {
        projectManager ++
    }
}
